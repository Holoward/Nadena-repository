...
{
    public static void AddPersistenceLayer(this IServiceCollection services, IConfiguration configuration, bool isProduction)
    {
        ...
        services.AddScoped<IDatasetStorageService, LocalDatasetStorageService>();
        
        var enableBackgroundJobs = configuration.GetValue<bool>("EnableBackgroundJobs", true);
